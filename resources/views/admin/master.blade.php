...
<head>
  ...
  <link href="{{ asset('datatable_custom/datatable_custom/css/vendor/dataTables.bootstrap5.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('datatable_custom/datatable_custom/css/vendor/responsive.bootstrap5.css') }}" rel="stylesheet" type="text/css" />
...
<body>
  ...
  <!--app-->
  <script src="{{ asset('datatable_custom/datatable_custom/js/vendor/jquery.dataTables.min.js') }}"></script>
  <script src="{{ asset('datatable_custom/datatable_custom/js/vendor/dataTables.bootstrap5.js') }}"></script>
  <script src="{{ asset('datatable_custom/datatable_custom/js/vendor/dataTables.responsive.min.js') }}"></script>
